...
[Documentation](documentation/index.md){ .md-button .md-button--secondary }
...
!!! tip "New release"
	**Sep. 5, 2026** - New **major** release [v0.5.1](releases.md): a generic operator algebra, spinless-fermion and boson blocks, an LOBPCG eigensolver, and improved memory efficiency

## Overview

XDiag is a library for performing **exact diagonalizations** of quantum many-body systems. It is designed to be both easy to use and highly performant, and consists of a core C++ library [xdiag](https://github.com/awietek/xdiag), and a convenient Julia wrapper [XDiag.jl](https://github.com/awietek/XDiag.jl).
