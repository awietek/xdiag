...
## News
* **Jul. 30, 2026** New **major** release [v0.5.0](releases.md) generic operator algebras support, spinless fermions, and bosons. Improved memory efficiency and LOBPCG implementation
