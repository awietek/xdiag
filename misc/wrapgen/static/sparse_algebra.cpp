...
static void register_csr(jlcxx::Module &mod, const char *name) {
  ...
  mod.method("fun_csr_apply_vec", [](CSRMatrix<idx_t, coeff_t> const &A,
                                     coeff_t *xin, coeff_t *yout, int64_t nin,
                                     int64_t nout) {
  ...
  mod.method("fun_csr_apply_mat", [](CSRMatrix<idx_t, coeff_t> const &A,
                                     coeff_t *xin, coeff_t *yout, int64_t nrin,
                                     int64_t ncols, int64_t nrout) {
    arma::Mat<coeff_t> x(xin, (arma::uword)nrin, (arma::uword)ncols, false, true);
    arma::Mat<coeff_t> y(yout, (arma::uword)nrout, (arma::uword)ncols, false, true);
    JULIA_XDIAG_CALL_VOID(apply(A, x, y));
  });
}
...
static void register_csr_apply_mixed(jlcxx::Module &mod) {
  mod.method("fun_csr_apply_vec", [](CSRMatrix<idx_t, double> const &A,
                                     complex *xin, complex *yout, int64_t nin,
                                     int64_t nout) {
    arma::Col<complex> x(xin, (arma::uword)nin, false, true);
    arma::Col<complex> y(yout, (arma::uword)nout, false, true);
    JULIA_XDIAG_CALL_VOID(apply(A, x, y));
  });
  mod.method("fun_csr_apply_mat", [](CSRMatrix<idx_t, double> const &A,
                                     complex *xin, complex *yout, int64_t nrin,
                                     int64_t ncols, int64_t nrout) {
    arma::Mat<complex> x(xin, (arma::uword)nrin, (arma::uword)ncols, false, true);
    arma::Mat<complex> y(yout, (arma::uword)nrout, (arma::uword)ncols, false, true);
    JULIA_XDIAG_CALL_VOID(apply(A, x, y));
  });
}
...
static void register_dense(jlcxx::Module &mod) {
  mod.method("fun_coo_to_dense", [](int64_t nrows, int64_t ncols, idx_t *row,
                                    idx_t *col, coeff_t *data, int64_t nnz, idx_t i0) {
    COOMatrix<idx_t, coeff_t> A{
        (idx_t)nrows, (idx_t)ncols,
        arma::Col<idx_t>(row, (arma::uword)nnz, false, true),
        arma::Col<idx_t>(col, (arma::uword)nnz, false, true),
        arma::Col<coeff_t>(data, (arma::uword)nnz, false, true), i0, false};
    JULIA_XDIAG_CALL_RETURN(to_dense(A));
  });
  mod.method("fun_csc_to_dense", [](int64_t nrows, int64_t ncols, idx_t *colptr,
                                    idx_t *row, coeff_t *data, int64_t nnz, idx_t i0) {
