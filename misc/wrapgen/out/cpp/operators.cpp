...
void define_operators(jlcxx::Module &mod) {
  ...
  mod.method("con_Op",
             [](std::string const &type) { JULIA_XDIAG_CALL_RETURN(Op(type)) });
  mod.method("con_Op", [](std::string const &type, int64_t site) {
    JULIA_XDIAG_CALL_RETURN(Op(type, site))
  });
  mod.method("con_Op",
             [](std::string const &type, arma::Col<int64_t> const &sites) {
  ...
  mod.method("mth_type",
             [](Op const &self) { JULIA_XDIAG_CALL_RETURN(self.type()) });
  mod.method("mth_size",
             [](Op const &self) { JULIA_XDIAG_CALL_RETURN(self.size()) });
  mod.method("op_getindex", [](Op const &self, int64_t idx) {
    JULIA_XDIAG_CALL_RETURN(self[idx])
  });
  mod.method("mth_hassites",
             [](Op const &self) { JULIA_XDIAG_CALL_RETURN(self.hassites()) });
  mod.method("mth_hasmatrix",
             [](Op const &self) { JULIA_XDIAG_CALL_RETURN(self.hasmatrix()) });
  mod.method("mth_isreal",
             [](Op const &self) { JULIA_XDIAG_CALL_RETURN(self.isreal()) });
  mod.method("op_eq", [](Op const &self, Op const &rhs) {
  ...
  mod.method("mth_size",
             [](Monomial const &self) { JULIA_XDIAG_CALL_RETURN(self.size()) });
  ...
  mod.method("op_eq", [](Monomial const &self, Monomial const &rhs) {
    JULIA_XDIAG_CALL_RETURN(self == rhs)
  });
  mod.method("mth_isreal", [](Monomial const &self) {
    JULIA_XDIAG_CALL_RETURN(self.isreal())
  });
  mod.method("op_mul", [](Op const &lhs, Op const &rhs) {
    JULIA_XDIAG_CALL_RETURN(lhs * rhs)
  });
  ...
  mod.method("op_setindex",
             [](OpSum &self, std::string const &name, double val) {
               JULIA_XDIAG_CALL_VOID(self[name] = val);
             });
  mod.method("op_setindex",
             [](OpSum &self, std::string const &name, complex val) {
               JULIA_XDIAG_CALL_VOID(self[name] = val);
             });
  mod.method("mth_plain",
             [](OpSum const &self) { JULIA_XDIAG_CALL_RETURN(self.plain()) });
  mod.method("mth_size",
             [](OpSum const &self) { JULIA_XDIAG_CALL_RETURN(self.size()) });
  mod.method("op_eq", [](OpSum const &self, OpSum const &rhs) {
    JULIA_XDIAG_CALL_RETURN(self == rhs)
  });
  mod.method("mth_isreal",
             [](OpSum const &self) { JULIA_XDIAG_CALL_RETURN(self.isreal()) });
  mod.method("op_mul", [](double coeff, Op const &op) {
    JULIA_XDIAG_CALL_RETURN(coeff * op)
  });
  ...
  mod.method("op_mul", [](Op const &op, double coeff) {
    JULIA_XDIAG_CALL_RETURN(op * coeff)
  });
  ...
  mod.method("op_mul", [](double coeff, Monomial const &mono) {
    JULIA_XDIAG_CALL_RETURN(coeff * mono)
  });
  ...
  mod.method("op_mul", [](Monomial const &mono, double coeff) {
    JULIA_XDIAG_CALL_RETURN(mono * coeff)
  });
