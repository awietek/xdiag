...
int main(int argc, char **argv) {
  ...
  auto lfile = FileToml(format("shastry.{}.HB.J.Jd.fsl.toml", nsites), 'r');
  auto ofile = FileH5(
      format(
          "outfiles/outfile.shastry.{}.J.{:.2f}.Jd.{:.2f}.nup.{}.k.{}.q.{}.h5",
          nsites, J, Jd, nup, kname, qname),
      "w!");
  ...
  Log("Diagonalizing H in block nup: {}, k+q: {}+{}", nup, kname, qname);
  ...
  for (int site = 0; site < nsites; ++site) {
    ...
    S_of_q_ops << Op("Sz", phase / nsites, site);
  }
