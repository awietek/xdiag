...
#ifndef HYDRA_PARAMETERS_OSIRIS_PARAMETERS_
#define HYDRA_PARAMETERS_OSIRIS_PARAMETERS_
...
class parameter_value 
{
 ...
 public:
  ...
  inline parameter_value& operator=(const int i)  
    {
...
class Parameters : public std::map<std::string,parameter_value>
{
 public:
  ...
  Parameters& operator<<(const Parameters& p ) {insert(p.begin(),p.end());return *this;}
...
class parameters_collection : public std::map<std::string,Parameters>
{
 public:
  ...
  parameters_collection(const parameters_collection& pc) : std::map<std::string,Parameters>(pc) {};
  parameters_collection(parser&);
  
  // copy/replace parameters into this one
  parameters_collection& operator<<(const parameters_collection& pc) {
    insert(pc.begin(),pc.end());return *this;
  }
