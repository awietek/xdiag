...
FileH5::FileH5(std::string filename, std::string iomode)
  ...
  if (iomode == "r") {
    Log.err("Error in hydra hdf5: read mode (r) currently not implemented");
  }
  ...
  // Open file in forced write mode
    ...
    if (file_id_ == H5I_INVALID_HID) {
      Log.err("Error in hydra hdf5: can't open file in (forced) write mode: {}",
              filename);
    }
  }
  ...
  // Open file in secure write mode
    ...
    if (file_id_ == H5I_INVALID_HID) {
      Log.err("Error in hydra hdf5: can't open file in write mode: {}",
              filename);
    }
  }
  ...
  // Open file in append mode
    ...
    Log.err("Error in hydra hdf5: append mode (a) currently not implemented");

  } else {
    Log.err("Error in hydra hdf5: invalid iomode, must be one of \"r\", \"w\", "
            "\"w!\", \"a\"");
  }
}
