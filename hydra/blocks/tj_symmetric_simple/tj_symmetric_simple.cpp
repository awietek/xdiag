...
tJSymmetricSimple<bit_t, GroupAction>::tJSymmetricSimple(
  ...
  utils::check_nup_ndn_tj(n_sites, nup, ndn, "tJSymmetricSimple");
...
template <class bit_t, class GroupAction>
idx_t tJSymmetricSimple<bit_t, GroupAction>::index(bit_t ups, bit_t dns) const {
...
template <class bit_t, class GroupAction>
bool tJSymmetricSimple<bit_t, GroupAction>::operator==(
    tJSymmetricSimple<bit_t, GroupAction> const &rhs) const {
