#include "electron_symmetric_simple.h"
...
ElectronSymmetricSimple<bit_t, GroupAction>::ElectronSymmetricSimple(
  ...
  utils::check_nup_ndn_electron(n_sites, nup, ndn, "ElectronSymmetricSimple");
...
ElectronSymmetricSimple<bit_t, GroupAction>::representative(bit_t ups,
                                                            bit_t dns) const {
...
ElectronSymmetricSimple<bit_t, GroupAction>::representative_index(
...
template <class bit_t, class GroupAction>
idx_t ElectronSymmetricSimple<bit_t, GroupAction>::index(bit_t ups,
                                                         bit_t dns) const {
...
template <class bit_t, class GroupAction>
idx_t ElectronSymmetricSimple<bit_t, GroupAction>::index_switch(
    bit_t ups, bit_t dns) const {
...
template <class bit_t, class GroupAction>
bool ElectronSymmetricSimple<bit_t, GroupAction>::operator==(
    ElectronSymmetricSimple<bit_t, GroupAction> const &rhs) const {
