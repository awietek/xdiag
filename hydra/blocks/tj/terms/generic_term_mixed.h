...
#endif
    for (idx_t up_in_idx = 0; up_in_idx < basis_in.n_rep_ups(); ++up_in_idx) {
      ...
      if (non_zero_term_ups(up_in)) {
        ...
        idx_t up_in_offset = basis_in.ups_offset(up_in_idx);
        ...
        idx_t up_out_offset = basis_out.ups_offset(idx_up_flip);
