...
ElectronSymmetric<bit_t>::ElectronSymmetric(int n_sites, int nup, int ndn,
...
template <typename bit_t>
bool ElectronSymmetric<bit_t>::operator==(
    ElectronSymmetric<bit_t> const &rhs) const {
...
template class ElectronSymmetric<uint16_t>;
template class ElectronSymmetric<uint32_t>;
template class ElectronSymmetric<uint64_t>;
