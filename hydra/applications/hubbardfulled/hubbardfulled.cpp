...
void run_real_complex(std::string real_complex, hydra::BondList bondlist,
                      hydra::Couplings couplings, hydra::qn_electron qn,
                      bool fulldiag, std::string outfile) {
...
int main(int argc, char *argv[]) {
  ...
  if (couplings.all_real())
    run_real_complex<double>(std::string("REAL"), bondlist, couplings, qn,
                             fulldiag, outfile);
  else
    run_real_complex<lila::complex>(std::string("COMPLEX"), bondlist, couplings,
                                    qn, fulldiag, outfile);
