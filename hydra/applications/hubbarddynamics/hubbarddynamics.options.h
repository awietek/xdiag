...
void parse_cmdline(std::string& outfile, std::string& latticefile, std::string& couplingfile, std::string& corrfile, int& nup, int& ndown, std::string& fermiontype, std::string& algorithm, double& precision, int& iters, double& dynprecision, int& dyniters, int& argc, char** argv)
{
