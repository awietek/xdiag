...
#include "clara.hpp"
    ...
    void parse_cmdline(std::string& outfile, std::string& latticefile, std::string& couplingfile, std::string& corrfile, int& nup, int& ndown, std::string& fermiontype, std::string& algorithm, int& dyniters, int& argc, char** argv)
  {
...
clara::Opt(couplingfile, "couplingfile")["-i"]["--couplingfile"]("name of couplingfile (default: latticefile)") |
