...
//  type             nsites      site_req  overlap  mat_req  is_real
  ...
  {"TotalN",        {undefined,  false,    false,   false,   true   }},
  {"TotalNup",      {undefined,  false,    false,   false,   true   }},
  {"TotalNdn",      {undefined,  false,    false,   false,   true   }},
  {"TotalSz",       {undefined,  false,    false,   false,   true   }},
  {"N",             {1,          true,     false,   false,   true   }},
  {"NN",            {2,          true,     true,    false,   true   }},
  {"ScalarChirality",{3,         true,     false,   false,   false  }},
  {"Hop",           {2,          true,     true,    false,   true   }},
  {"HopAsym",       {2,          true,     true,    false,   true   }},
  {"Hopup",         {2,          true,     true,    false,   true   }},
  {"Hopdn",         {2,          true,     true,    false,   true   }},
  {"HopupAsym",     {2,          true,     true,    false,   true   }},
  {"HopdnAsym",     {2,          true,     true,    false,   true   }},
  ...
  {"NtotNtot",      {2,          true,     true,    false,   true   }},
  {"NupdnNupdn",    {2,          true,     true,    false,   true   }},
  {"tJSzSz",        {2,          true,     true,    false,   true   }},
  {"tJSdotS",       {2,          true,     true,    false,   true   }},
  {"Matrix",        {undefined,  true,     true,    true,    false  }},
  {"NupNdn",        {2,          true,     true,    false,   true   }},
  {"NupNup",        {2,          true,     true,    false,   true   }},
  {"NdnNdn",        {2,          true,     true,    false,   true   }},
  {"NdnNup",        {2,          true,     true,    false,   true   }},
};
// clang-format on
