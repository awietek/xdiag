...
BasisSpinhalfDistributed<bit_t>::BasisSpinhalfDistributed(int64_t nsites, int64_t nup)
...
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::nsites() const {
  return nsites_;
}
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::nup() const { return nup_; }
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::n_prefix_bits() const {
  return n_prefix_bits_;
};
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::n_postfix_bits() const {
  return n_postfix_bits_;
}

template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::dim() const { return dim_; }
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::size() const { return size_; }
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::size_transpose() const {
  return size_transpose_;
}
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::size_max() const {
  return size_max_;
}
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::size_min() const {
  return size_min_;
}
template <typename bit_t>
typename BasisSpinhalfDistributed<bit_t>::iterator_t BasisSpinhalfDistributed<bit_t>::begin() const {
  return iterator_t(*this, true);
}
template <typename bit_t>
typename BasisSpinhalfDistributed<bit_t>::iterator_t BasisSpinhalfDistributed<bit_t>::end() const {
  return iterator_t(*this, false);
}
template <typename bit_t> int64_t BasisSpinhalfDistributed<bit_t>::index(bit_t spins) const {
...
template <typename bit_t>
int64_t BasisSpinhalfDistributed<bit_t>::prefix_begin(bit_t prefix) const {
...
template <typename bit_t>
std::vector<bit_t> const &BasisSpinhalfDistributed<bit_t>::postfixes() const {
  return postfixes_;
}
template <typename bit_t>
int64_t BasisSpinhalfDistributed<bit_t>::postfix_begin(bit_t postfix) const {
...
template <typename bit_t>
mpi::CommPattern &BasisSpinhalfDistributed<bit_t>::comm_pattern() const {
  return comm_pattern_;
}

template <typename bit_t>
mpi::Communicator BasisSpinhalfDistributed<bit_t>::transpose_communicator(bool reverse) const {
  return reverse ? transpose_communicator_reverse_ : transpose_communicator_;
}

template class BasisSpinhalfDistributed<uint32_t>;
template class BasisSpinhalfDistributed<uint64_t>;

template <typename bit_t>
BasisSpinhalfDistributedIterator<bit_t>::BasisSpinhalfDistributedIterator(BasisSpinhalfDistributed<bit_t> const &basis, bool begin)
...
template <typename bit_t>
BasisSpinhalfDistributedIterator<bit_t> &BasisSpinhalfDistributedIterator<bit_t>::operator++() {
  ++postfix_idx_;
...
template <typename bit_t> bit_t BasisSpinhalfDistributedIterator<bit_t>::operator*() const {
  return (prefix_ << basis_.n_postfix_bits()) |
         basis_.postfix_states(prefix_)[postfix_idx_];
}

template <typename bit_t>
bool BasisSpinhalfDistributedIterator<bit_t>::operator!=(
    BasisSpinhalfDistributedIterator<bit_t> const &rhs) const {
