...
// The BitArray<1..8> / BitArrayLong<1..8> backends used by the boson bases.
#define INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP_BITARRAY(NUMBER_TYPE)         \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArray1, NUMBER_TYPE)             \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArray2, NUMBER_TYPE)             \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArray3, NUMBER_TYPE)             \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArray4, NUMBER_TYPE)             \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArray5, NUMBER_TYPE)             \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArray6, NUMBER_TYPE)             \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArray7, NUMBER_TYPE)             \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArray8, NUMBER_TYPE)             \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArrayLong1, NUMBER_TYPE)         \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArrayLong2, NUMBER_TYPE)         \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArrayLong3, NUMBER_TYPE)         \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArrayLong4, NUMBER_TYPE)         \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArrayLong5, NUMBER_TYPE)         \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArrayLong6, NUMBER_TYPE)         \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArrayLong7, NUMBER_TYPE)         \
  INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP(BitArrayLong8, NUMBER_TYPE)
...
INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP_BITARRAY(double);
...
INSTANTIATE_XDIAG_BASIS_NON_BRANCHING_OP_BITARRAY(complex);
