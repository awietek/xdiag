...
#include <xdiag/blocks/electron/terms/apply_exchange.hpp>
#include <xdiag/blocks/electron/terms/apply_hopping.hpp>
#include <xdiag/blocks/electron/terms/apply_ising.hpp>
#include <xdiag/blocks/electron/terms/apply_number.hpp>
