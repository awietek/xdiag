  ...
  std::visit(
      overload{
          ...
          [&](BasisNp<uint16_t> const &idx_in,
            ...
            apply_terms<uint16_t, coeff_t, false>(bonds, idx_in, idx_out, fill, zero_precision);
          },
          ...
          [&](BasisSymmetricNp<uint16_t> const &idx_in,
            ...
            apply_terms<uint16_t, coeff_t, true>(bonds, idx_in, idx_out, fill, zero_precision);
          },
          ...
          [&](BasisNp<uint32_t> const &idx_in,
            ...
            apply_terms<uint32_t, coeff_t, false>(bonds, idx_in, idx_out, fill, zero_precision);
          },
          ...
          [&](BasisSymmetricNp<uint32_t> const &idx_in,
            ...
            apply_terms<uint32_t, coeff_t, true>(bonds, idx_in, idx_out, fill, zero_precision);
          },
          ...
          [&](BasisNp<uint64_t> const &idx_in,
            ...
            apply_terms<uint64_t, coeff_t, false>(bonds, idx_in, idx_out, fill, zero_precision);
          },
          ...
          [&](BasisSymmetricNp<uint64_t> const &idx_in,
            ...
            apply_terms<uint64_t, coeff_t, true>(bonds, idx_in, idx_out, fill, zero_precision);
          },
