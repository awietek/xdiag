...
// int64_t, double
template std::vector<int64_t> csr_matrix_nnz<int64_t, double>(OpSum const &,
                                                              Spinhalf const &,
                                                              Spinhalf const &,
                                                              bool);
template std::vector<int64_t>
csr_matrix_nnz<int64_t, double>(OpSum const &, tJ const &, tJ const &, bool);
template std::vector<int64_t> csr_matrix_nnz<int64_t, double>(OpSum const &,
                                                              Electron const &,
                                                              Electron const &,
                                                              bool);
...
// int64_t, complex
template std::vector<int64_t> csr_matrix_nnz<int64_t, complex>(OpSum const &,
                                                               Spinhalf const &,
                                                               Spinhalf const &,
                                                               bool);
template std::vector<int64_t>
csr_matrix_nnz<int64_t, complex>(OpSum const &, tJ const &, tJ const &, bool);
template std::vector<int64_t> csr_matrix_nnz<int64_t, complex>(OpSum const &,
                                                               Electron const &,
                                                               Electron const &,
                                                               bool);
...
// int32_t, complex
template std::vector<int32_t> csr_matrix_nnz<int32_t, complex>(OpSum const &,
                                                               Spinhalf const &,
                                                               Spinhalf const &,
                                                               bool);
template std::vector<int32_t>
csr_matrix_nnz<int32_t, complex>(OpSum const &, tJ const &, tJ const &, bool);
template std::vector<int32_t> csr_matrix_nnz<int32_t, complex>(OpSum const &,
                                                               Electron const &,
                                                               Electron const &,
                                                               bool);
