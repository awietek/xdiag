...
// int64_t, double
XDIAG_API CSCMatrix<int64_t, double>
csc_matrix(OpSum const &ops, Block const &block, int64_t i0 = 0);
XDIAG_API CSCMatrix<int64_t, double> csc_matrix(OpSum const &ops,
