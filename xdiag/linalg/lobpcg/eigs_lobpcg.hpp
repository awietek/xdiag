...
struct XDIAG_API EigsLobpcgResult {
...
// on-the-fly
XDIAG_API EigsLobpcgResult eigs_lobpcg(OpSum const &ops, Block const &block,
...
XDIAG_API EigsLobpcgResult eigs_lobpcg(CSRMatrix<idx_t, coeff_t> const &A,
