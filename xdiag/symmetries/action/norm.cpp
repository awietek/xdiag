...
INSTANTIATE_NORM_SP(BitArray5);
INSTANTIATE_NORM_SP(BitArray6);
INSTANTIATE_NORM_SP(BitArray7);
...
INSTANTIATE_NORM_SP(BitArrayLong5);
INSTANTIATE_NORM_SP(BitArrayLong6);
INSTANTIATE_NORM_SP(BitArrayLong7);
