...
inline std::tuple<BondList, Couplings>
...
inline std::tuple<BondList, Couplings> tJchain(int n_sites, double t,
                                               double J) {
...
inline std::tuple<BondList, Couplings, lila::Vector<double>>
randomAlltoAll4NoU() {
  BondList bondlist;
  Couplings couplings;
  // couplings["T01"] = 3;
...
inline std::tuple<BondList, Couplings, lila::Vector<double>> randomAlltoAll4() {
  BondList bondlist;
  Couplings couplings;
  // couplings["U"] = 5;
  // couplings["T01"] = 3;
