...
void test_tjmodel_heisenberg(hydra::BondList bondlist,
                             hydra::Couplings couplings, int max_nup = -1) {
...
void test_tjmodel_e0(hydra::BondList bondlist, hydra::Couplings couplings,
                     hydra::qn_tj qn, double e0) {
  using namespace hydra;
...
void test_tjmodel_fullspectrum(hydra::BondList bondlist,
                               hydra::Couplings couplings, bool ninj_term,
                               std::string filename) {
  using namespace hydra;
...
void test_tjmodel_hermitian(hydra::BondList bondlist,
...
TEST_CASE("TJModel", "[TJModel]") {
  ...
  std::vector<qn_tj> qns;
  qns.push_back({0, 0});
  e0s.push_back(0.000000000);
  qns.push_back({0, 1});
  e0s.push_back(-1.99999999);
  qns.push_back({0, 2});
  e0s.push_back(-2.960813110);
  qns.push_back({0, 3});
  e0s.push_back(-3.79610527);
  qns.push_back({0, 4});
  e0s.push_back(-2.46081311);
  qns.push_back({0, 5});
  e0s.push_back(-0.99999999);
  qns.push_back({0, 6});
  e0s.push_back(1.500000000);
  qns.push_back({1, 1});
  e0s.push_back(-3.61222054);
  qns.push_back({1, 2});
  e0s.push_back(-4.04537829);
  qns.push_back({1, 3});
  e0s.push_back(-4.10768318);
  qns.push_back({1, 4});
  e0s.push_back(-2.42705097);
  qns.push_back({1, 5});
  e0s.push_back(-0.49999999);
  qns.push_back({2, 2});
  e0s.push_back(-4.16447847);
  qns.push_back({2, 3});
  e0s.push_back(-3.52922048);
  qns.push_back({2, 4});
  e0s.push_back(-2.11803398);
  qns.push_back({3, 3});
  e0s.push_back(-2.80277563);
  ...
  e0s.push_back(-1.99999999);
  qns.push_back({0, 2});
  e0s.push_back(-3.00000000);
  qns.push_back({0, 3});
  e0s.push_back(-4.00000000);
  qns.push_back({0, 4});
  e0s.push_back(-2.99999999);
  qns.push_back({0, 5});
  e0s.push_back(-2.00000000);
  qns.push_back({0, 6});
  e0s.push_back(0.000000000);
  qns.push_back({1, 1});
  e0s.push_back(-3.46410161);
  qns.push_back({1, 2});
  e0s.push_back(-3.99999999);
  qns.push_back({1, 3});
  e0s.push_back(-3.46410161);
  qns.push_back({1, 4});
  e0s.push_back(-1.99999999);
  ...
  for (auto L : Ls) {
    ...
    std::stringstream ss;
    ss << "data/tjfullspectrum/spectrum.chain." << L << ".txt";
