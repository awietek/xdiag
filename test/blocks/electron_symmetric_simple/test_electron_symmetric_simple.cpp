...
void test_indices(ElectronSymmetricSimple<bit_t> const &electron) {
...
template <class bit_t>
void test_representative_character(
    ElectronSymmetricSimple<bit_t> const &electron) {
...
template <class bit_t> void test_electron_chain_simple(int n_sites) {

  lila::Log.out("ElectronSymmetricSimple chain test, N: {}", n_sites);
...
TEST_CASE("ElectronSymmetricSimple", "[models][ElectronSymmetricSimple]") {
  ...
  //       auto electron =
  //           ElectronSymmetricSimple<uint16>(n_sites, nup, ndn, space_group,
  //           irrep);
  ...
  // ElectronSymmetricSimpleV2(n_sites, nup, ndn, space_group, irrep);
}
