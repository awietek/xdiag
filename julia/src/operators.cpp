...
void define_operators(jlcxx::Module &mod) {
  ...
  mod.method("con_Monomial", [](std::initializer_list<Op> ops) {
  ...
  mod.method("mth_begin",
             [](Monomial &self) { JULIA_XDIAG_CALL_RETURN(self.begin()) });
  mod.method("mth_end",
             [](Monomial &self) { JULIA_XDIAG_CALL_RETURN(self.end()) });
  ...
  mod.method("con_Op",
             [](std::string type, int64_t site, Matrix const &matrix) {
               JULIA_XDIAG_CALL_RETURN(Op(type, site, matrix))
             });
  mod.method("con_Op", [](std::string type, std::vector<int64_t> const &sites,
                          Matrix const &matrix) {
  ...
  mod.method("mth_matrix",
             [](const Op &self) { JULIA_XDIAG_CALL_RETURN(self.matrix()) });
  mod.method("mth_isreal",
  ...
  mod.method("con_OpSum", [](Scalar const &coeff, Op const &op) {
    JULIA_XDIAG_CALL_RETURN(OpSum(coeff, op))
  });
  mod.method("con_OpSum", [](Scalar const &coeff, Monomial const &mono) {
    JULIA_XDIAG_CALL_RETURN(OpSum(coeff, mono))
  });
  mod.method("con_OpSum", [](Coeff const &coeff, Op const &op) {
    JULIA_XDIAG_CALL_RETURN(OpSum(coeff, op))
  });
  mod.method("con_OpSum", [](Coeff const &coeff, Monomial const &mono) {
    JULIA_XDIAG_CALL_RETURN(OpSum(coeff, mono))
  });
  ...
  mod.method("mth_operator*=", [](OpSum &self, Scalar const &scalar) {
    JULIA_XDIAG_CALL_RETURN(self.operator*=(scalar))
  });
  mod.method("mth_operator/=", [](OpSum &self, Scalar const &scalar) {
    JULIA_XDIAG_CALL_RETURN(self.operator/=(scalar))
  ...
  mod.method("mth_terms",
             [](OpSum &self) { JULIA_XDIAG_CALL_RETURN(self.terms()) });
  mod.method("mth_params",
             [](OpSum &self) { JULIA_XDIAG_CALL_RETURN(self.params()) });
  mod.method("mth_size",
             [](OpSum &self) { JULIA_XDIAG_CALL_RETURN(self.size()) });
  mod.method("mth_begin",
             [](OpSum &self) { JULIA_XDIAG_CALL_RETURN(self.begin()) });
  mod.method("mth_end",
             [](OpSum &self) { JULIA_XDIAG_CALL_RETURN(self.end()) });
  mod.method("mth_operator==", [](OpSum const &self, OpSum const &rhs) {
    JULIA_XDIAG_CALL_RETURN(self.operator==(rhs))
  });
  mod.method("mth_operator!=", [](OpSum const &self, OpSum const &rhs) {
  ...
  mod.method("fun_operator*", [](Coeff const &coeff, Op const &op) {
    JULIA_XDIAG_CALL_RETURN(operator*(coeff, op))
  });
  mod.method("fun_operator*", [](Scalar const &coeff, Op const &op) {
    JULIA_XDIAG_CALL_RETURN(operator*(coeff, op))
  });
  ...
  mod.method("fun_operator*", [](Op const &op, Coeff const &coeff) {
    JULIA_XDIAG_CALL_RETURN(operator*(op, coeff))
  });
  mod.method("fun_operator*", [](Op const &op, Scalar const &coeff) {
    JULIA_XDIAG_CALL_RETURN(operator*(op, coeff))
  });
  ...
  mod.method("fun_operator*", [](Coeff const &coeff, Monomial const &mono) {
    JULIA_XDIAG_CALL_RETURN(operator*(coeff, mono))
  });
  mod.method("fun_operator*", [](Scalar const &coeff, Monomial const &mono) {
    JULIA_XDIAG_CALL_RETURN(operator*(coeff, mono))
  });
  ...
  mod.method("fun_operator*", [](Monomial const &mono, Coeff const &coeff) {
    JULIA_XDIAG_CALL_RETURN(operator*(mono, coeff))
  });
  mod.method("fun_operator*", [](Monomial const &mono, Scalar const &coeff) {
    JULIA_XDIAG_CALL_RETURN(operator*(mono, coeff))
  });
  ...
  mod.method("fun_operator*", [](Scalar const &scalar, OpSum const &ops) {
    JULIA_XDIAG_CALL_RETURN(operator*(scalar, ops))
  });
  ...
  mod.method("fun_operator*", [](OpSum const &ops, Scalar const &scalar) {
    JULIA_XDIAG_CALL_RETURN(operator*(ops, scalar))
  });
  mod.method("fun_operator/", [](OpSum const &ops, double scalar) {
    JULIA_XDIAG_CALL_RETURN(operator/(ops, scalar))
