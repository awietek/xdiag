...
namespace jlcxx {
template <>
struct IsMirroredType<xdiag::CSRMatrix<int64_t, double>> : std::false_type {};
template <>
struct IsMirroredType<xdiag::CSRMatrix<int64_t, xdiag::complex>>
    : std::false_type {};
template <>
struct IsMirroredType<xdiag::CSRMatrix<int32_t, double>> : std::false_type {};
template <>
struct IsMirroredType<xdiag::CSRMatrix<int32_t, xdiag::complex>>
    : std::false_type {};
} // namespace jlcxx
